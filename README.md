...
2. composer install
3. php init
4. Настройка СУБД: common\config\main-local.php
5. yii migrate
...
Тестовый проект находиться здесь:
	http://apples-test-app.eh5.ru/

1. Регистрируем новый пользователь 
2. Активируем учетку по инструкцию
3. Переходим Dashboard
4. Вход логин/пароль
